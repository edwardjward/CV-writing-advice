...
### BEWARE: DO NOT COPY OR REPLICATE THESE CVS.
...
* [Canva](https://www.canva.com/templates/resumes/) - Choose a template and edit in the browser
* [Creddle](http://creddle.io/) - Traditional style CV templates with online editor 
* [Flow CV](https://flowcv.io/) - Templates with online editor and suggest-change options for guests to comment

## Lets look at the structure and order of topics

### Personal Details
Include first name, last name, phone number, email address, GithHub and Linked In. Some people don't like to put their actual address and prefer to just reference their City, or City and Zip Code. Keep your Github clean. These days there’s no need to include your date of birth or a photo.
...
2) either **Other Experience, Employment, or Professional Experience**.
